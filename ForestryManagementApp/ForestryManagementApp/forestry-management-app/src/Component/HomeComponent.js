                    ...
                    <div className="row mb-2">
                        <div className="col-md-6">
                            <div
                                ...
                                <div className="col-auto d-none d-lg-block view overlay zoom">
                                    <img className="bd-placeholder-img" width="200" height="250" src={land} alt="" />
                        ...
                        <div className="col-md-6">
                            <div
                                ...
                                <div className="col-auto d-none d-lg-block view overlay zoom">
                                    <img className="bd-placeholder-img" width="200" height="250" src={customer} alt="" />
                        ...
                        <div className="col-md-6">
                            <div
                                ...
                                <div className="col-auto d-none d-lg-block view overlay zoom">
                                    <img className="bd-placeholder-img" width="200" height="250" src={scheduler} alt="" />
                        ...
                        <div className="col-md-6">
                            <div
                                ...
                                <div className="col-auto d-none d-lg-block view overlay zoom">
                                    <img className="bd-placeholder-img" width="200" height="250" src={admin} alt="" />
