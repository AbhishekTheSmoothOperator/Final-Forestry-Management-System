                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input defaultValue={customer.customerId} type="text" ref={this.customerId}  required/></td>
                                    </tr>
                                    <tr>
                                        <td><label>Name:</label></td>
                                        <td><input defaultValue={customer.customerName} type="text" ref={this.customerName} required /></td>
                                    </tr>
                                    <tr>
                                        <td><label>Email:</label></td>
                                        <td><input defaultValue={customer.customerEmail} type="text" ref={this.customerEmail}  required/></td>
                                    </tr>
                                    <tr>
                                        <td><label>Address:</label></td>
                                        <td><input defaultValue={customer.customerAddress} type="text" ref={this.customerAddress} required /></td>
                                    </tr>
                                    <tr>
                                        <td><label>Town:</label></td>
                                        <td><input defaultValue={customer.customerTown} type="text" ref={this.customerTown}  required/></td>
                                    </tr>
                                    <tr>
                                        <td><label>PostalCode:</label></td>
                                        <td><input defaultValue={customer.customerPostalCode} type="text" ref={this.customerPostalCode} required /></td>
                                    </tr>
                                    <tr>
                                        <td><label>Contact:</label></td>
                                        <td><input defaultValue={customer.customerContact} type="text" ref={this.customerContact}  required/></td>
                                    </tr>
                                    <tr>
