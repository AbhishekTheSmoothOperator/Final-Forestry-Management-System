        ...
        return (
            <div>
                <div class="container">
                    ...
                    <label>Land Id:</label>
                    <input type="text" placeholder="Land Id" name="landId" id="landId" value={this.state.landId} onChange={this.handleInputChange} required></input>


                    <label>Land Area:</label>
                    <input type="text" placeholder="Land Area" name="landArea" id="landArea" value={this.state.landArea} onChange={this.handleInputChange} required></input>


                    <label>Survey Number:</label>
                    <input type="text" placeholder="Survey Number" name="surveyNumber" id="surveyNumber" value={this.state.surveyNumber} onChange={this.handleInputChange} required></input>


                    <label>Owner Name:</label>
                    <input type="text" placeholder="Owner Name" name="ownerName" id="ownerName" value={this.state.ownerName} onChange={this.handleInputChange} required></input>
