        ...
        return (
            <div>
                <div class="container">
                    ...
                    <input type="text" placeholder="Contract Number" name="contractNumber" id="contractNumber" value={this.state.contractNumber} onChange={this.handleInputChange} required></input>
