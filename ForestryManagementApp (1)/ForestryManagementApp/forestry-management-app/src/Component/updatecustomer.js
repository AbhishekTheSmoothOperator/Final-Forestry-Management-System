...
class UpdateCustomerById extends Component {
    ...
    updateCustomer(e) {
        ...
        if(this.props.isUpdated===true){
            return alert("customer is updated successfully");
        }
    ...
    render() {
        ...
        if(customer !== undefined && isUpdated) {
            return <Redirect to='/getallcustomers'/>
        }
...
export default connect(mapStateToProps, mapDispatchToProps)(UpdateCustomerById);